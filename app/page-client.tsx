    ...
    return (
      <li key={match.id}>
        <article
          ...
          className="group relative flex cursor-pointer flex-col gap-4 rounded-[28px] border border-slate-200 bg-white px-5 py-6 shadow-sm transition hover:shadow-lg"
          onClick={(event) => {
