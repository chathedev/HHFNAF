    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[36px] border border-gray-200 bg-gradient-to-br from-white via-emerald-50 to-lime-50 shadow-[0_30px_90px_rgba(15,23,42,0.08)]">
            <div className="grid gap-10 px-6 py-10 md:grid-cols-[1.2fr_0.8fr] md:px-10">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl font-black tracking-tight text-gray-900 sm:text-5xl">Härnösands HF Supportershop</h1>
                <p className="text-lg text-gray-600">
                  Köp HHF-merch på <span className="font-semibold text-gray-900">shop.harnosandshf.se</span>. Shoppen
                ...
                <div className="flex flex-wrap gap-3 text-sm font-medium text-gray-700">
                  <div className="rounded-full border border-emerald-200 bg-white px-4 py-2">Ingen leverans</div>
                  <div className="rounded-full border border-emerald-200 bg-white px-4 py-2">Endast upphämtning</div>
                  <div className="rounded-full border border-emerald-200 bg-white px-4 py-2">Officiell HHF-merch</div>
                </div>
                ...
                {shopVisible && (
                  <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                    <Link
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-center gap-2 rounded-full bg-emerald-600 px-8 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-white transition hover:bg-emerald-500"
                    >
                ...
                <div className="mt-6 space-y-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-300">Lägg till merch i flödet där besökarna redan följer matcher och köper biljetter.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-300">Pickup only gör beställningen enkel att förstå direkt på sidan.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {shopHighlights.map((item) => (
              <article key={item.title} className="rounded-[24px] border border-gray-100 bg-gradient-to-br from-white via-slate-50 to-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="mt-6 inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-emerald-600">
                  <span className="h-2 w-2 rounded-full bg-emerald-600" /> HHF Shop
                </div>
              </article>
            ))}
          </div>
          ...
          {shopVisible && (
            <div className="mt-12 rounded-[32px] border border-dashed border-emerald-200 bg-emerald-50 p-8 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-700">Pickup only</p>
